...
CREATE TABLE enrollments (
    ...
    progress_percent REAL NOT NULL DEFAULT 0.00 CHECK (progress_percent BETWEEN 0 AND 100),
    source_id INTEGER NOT NULL,
    FOREIGN KEY (student_id) REFERENCES students(student_id) ON DELETE CASCADE,
    FOREIGN KEY (course_id) REFERENCES courses(course_id) ON DELETE CASCADE,
    FOREIGN KEY (source_id) REFERENCES record_sources(source_id),
...
INSERT INTO record_sources (source_name) VALUES
('Manual Entry'),
('Import'),
('Advisor Request');
...
INSERT INTO students (full_name, email, program_id, status_id) VALUES
...
INSERT INTO enrollments (student_id, course_id, enrollment_date, progress_percent, source_id) VALUES
...
INSERT INTO submissions (assignment_id, student_id, submitted_at, score, grader_note) VALUES
...
INSERT INTO activity_logs (event_type, reference_table, reference_id, event_note) VALUES
